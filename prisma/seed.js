...
const scheduleRoutines = [
  {
    ...
    menuId: 1,
    routineType: "weekly",
    weekdays: 1 + 32, // Sunday(1) + Friday(32)
    isEnabled: true,
    createdAt: daysAgo(90),
    updatedAt: daysAgo(90),
  },
...
async function seed() {
  ...
  await prisma.scheduleRoutine.createMany({ data: scheduleRoutines });
  // Note: DailySchedules are usually generated by app logic, skipping static seed for now
